...
int main(void){
    ...
    while(end_check() != 1){
        ...
        // do not account for player numbers here, mod%player_num is done in functions
        ++pos;
    }
...
void roll_prompt(uint32_t pos){
    printf("%s rolls...", names[pos % player_num]);
}
