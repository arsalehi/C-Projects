...
void test_bf(BloomFilter *bf) {
  char *words[] = {
      "word",    "another",   "quick",   "verylong",  "wow",
      "rocket",  "league",    "is",      "addicting", "xd",
      "sadge",   "monkaW",    "monkaS",  "pepelaugh", "pepemeltdown",
      "hasmods", "widepeepo", "pog",     "pogchamp",  "laksdajsdlkf",
      "eleven",  "number",    "hahahah", "fourteen",  "ting",
      "real",    "quentin",   "juliana", "sammy",     "daddy"};

  char *keys[] = {"word",   "another", "quick",   "verylong",  "wow",
                  "rocket", "league",  "is",      "addicting", "laksdajsdlkf",
                  "eleven", "number",  "hahahah", "fourteen",  "ting",
                  "real",   "quentin", "juliana", "sammy",     "daddy"};
  int key_size = 20;
  int word_size = 30;
...
void test_hash() {
  ...
  lookup->gs->oldspeak); } else { printf("Node does not exist\n");
  }
  */
